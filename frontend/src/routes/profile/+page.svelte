	...
	<div class="profile-container">
		<div class="user-container">
			...
			<div class="followers-list-container">
				<Button action={() => selectedList = (selectedList === "Followers") ? '' : 'Followers'} buttonText="Followers: {followers.length}"/>
				...
				<div class="following-list-container">
					...
					<Button action={() => selectedList = (selectedList === "Following") ? '' : 'Following'} buttonText="Following: {following.length}"/>
...
.followers-list-container, .following-list-container {
    margin-left: 5rem;
    margin-top: 1.8rem;
}
...
.following-list-content, .followers-list-content{
	position: absolute;
	z-index: 1000;
...
.followers-list-content a, .following-list-content a{
	display: block;
	padding: 0.2rem;
	margin: 0.5rem;
	background-color: white;
...
.followers-list-content a:hover, .following-list-content a:hover{
