...
/*
Get a song by platform and platform_specific_id, should have been
saved when querying the library of the user
*/
...
/*
Get an album by platform and platform_specific_id, should have been
saved when querying the library of the user
*/
...
/*
Get a playlist by platform and platform_specific_id, should have been
saved when querying the library of the user
*/
...
/*
Get an artist by platform and platform_specific_id, should have been
saved when querying the library of the user
*/
