...
/*
Create a new library and connection for a user based on the platform, with the provided tokens
*/
...
/*
Get the tokens for a platform based on the platform, and the user id
*/
